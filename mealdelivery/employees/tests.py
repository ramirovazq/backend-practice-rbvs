...
class EmployeeTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.employee1 = Employee.objects.create(
            name="Felipe Gómez",
            slack_webhook_url="http://www.mealdelivery.test/felipe"
        )
    ...
    def test_create_employee_success(self):
        response = self.client.post(reverse('employee-create'), {'name': "Fernando", "slack_webhook_url": "http://www.testmeal.com/webhook"}, follow=True)
    ...
    def test_edit_employee_success(self):
        ...
        response = self.client.post(reverse('employee-update', kwargs={'pk': self.employee2.id}), {'name': "Armando Gomez", "slack_webhook_url": self.employee2.slack_webhook_url}, follow=True)
        self.assertEqual(response.status_code, 200)
