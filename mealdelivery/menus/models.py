...
class Menu(models.Model):
    ...
    date_menu = models.DateField(blank=False, null=False)
...
class MenuLinkperEmployee(models.Model):
    menu = models.ForeignKey(Menu, on_delete=models.PROTECT, db_index=True)
    ...
    def options_selected(self):
        ...
        return EmployeeOption.objects.filter(menu=self.menu, employee=self.employee)
